                ...
                switch (pos + 1) {
                    ...
                    case 1: {
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                            ...
                            int permissionCheck = ContextCompat.checkSelfPermission(Home_05.this, Manifest.permission.CAMERA);

                            if (permissionCheck == PackageManager.PERMISSION_DENIED) {
                                // 권한 없음
                                ActivityCompat.requestPermissions(Home_05.this, new String[]{Manifest.permission.CAMERA}, REQ_CAMERA_SELECT);
                    ...
                    case 2: {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                            ...
                            int permissionCheck = ContextCompat.checkSelfPermission(Home_05.this, Manifest.permission.READ_EXTERNAL_STORAGE);

                            if (permissionCheck == PackageManager.PERMISSION_DENIED) {
                                // 권한 없음
                                ActivityCompat.requestPermissions(Home_05.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, REQ_PICTURE_SELECT);
                            } else {    // ACCESS_FINE_LOCATION 에 대한 권한이 이미 있음.
